...
/// <summary>
/// Service for rotating (archiving) the trade journal to dated backups.
...
public interface IJournalRotationService
{
    ...
    /// Source: trade-journal.jsonl → trade-journal-{yyyyMMdd}.jsonl
    /// </summary>
    /// <param name="journalPath">Path to the current journal file (e.g., logs/trade-journal.jsonl)</param>
